...
\begin{stz}[Levi-Civita-Zusammenhang]
...
\begin{proof}
  ...
  \begin{align*}
%    f_{*p}\left( \left( \nabla_\del{i}\del{j} \right)(p) \right) &= f_{*p}\left(
%    \Gamma^k_{ij}(p)\del{k}\Big|_p \right) \\
%    &= \Gamma^k_{ij}(p) f_{*p}\left( \del{k}\Big|_p \right) = \tilde
%    \Gamma^k_{ij}\left( f(p) \right)\dd{y^k}{}\Big|_{f(p)} \\
%    &= \left( \nabla_{\dd{y^i}{}}\dd{y^j}{} \right)\left( f(p) \right)
  \end{align*}
  und damit
